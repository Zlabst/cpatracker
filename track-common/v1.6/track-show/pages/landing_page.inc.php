...
<div class="row" id="master-form">
    <div class="col-md-12">
    	...
    	<pre>&lt;!--cpatracker.ru start--&gt;&lt;script type="text/javascript"&gt; ;(function(){if(window.cpa_inited)return;window.cpa_inited=true;var a=document.createElement("script");a.type="text/javascript";var b=""; if(typeof this.href!="undefined"){b=this.href.toString().toLowerCase()}else{b=document.location.toString().toLowerCase()}; a.async=true;a.src="<?php echo tracklink(); ?>/cookie.js?rnd="+Math.random(); var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(a,s)})();&lt;/script&gt;&lt;!--cpatracker.ru end--&gt;</pre>
