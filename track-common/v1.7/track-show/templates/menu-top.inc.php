...
<div class="top-navbar<?php echo $menu_toggle_class; ?>">
    ...
    echo 'class="active"';
                ...
                <li><a href="#" onclick="jivo_api.setContactInfo({email : '<?php echo $auth_info[1];?>', phone: '<?php echo filter_var($_DB_NAME, FILTER_SANITIZE_NUMBER_INT);?>'}); jivo_api.open(); return false;">Поддержка</a></li>
            </ul>
