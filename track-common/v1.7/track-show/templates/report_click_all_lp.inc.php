...
<div class="table-report-box">
    <table class="table table-striped table-bordered table-report dataTableT<?php echo $table_n; ?>">
        <thead>
        ...
        <tbody>
            ...
            foreach ($var['arr_report_data'] as $r) {
                ...
                echo '<tr><td nowrap="" class="report-header">' . $name . '</td><td>' .
                $r['cnt'] . '</td><td>' .
                t_repeated($r) . '</td><td>' .
                t_lpctr($r) . '</td><td>' .
                ...
                t_price($r) . '</td><td class="col_s col_a ' . pos_class($r['income'] - $r['price']) . '">' .
