...
foreach ($var['data'] as $row) {
    ...
    // Иконка ОС
    if($row['user_os'] = 'Android') {
        $icon_os = 'android';
    } elseif($row['user_os'] = 'Linux') {
        $icon_os = 'linux';
    } elseif($row['user_os'] = 'Mac OS X'){
        $icon_os = 'apple-ios';
    } else {
        $icon_os = '';
    }
    ...
    <tr>
        ...
        <td class="accordion-toggle" data-toggle="collapse-next"><!--<i class="cpa cpa-tablet"></i>--></td>
