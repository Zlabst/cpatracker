...
class Adsup {
    ...
    public $network_name = 'Adsup';
    private $display_url = 'www.adsup.me';
    private $registration_url = 'http://www.cpatracker.ru/networks/adsup';
    private $network_description = 'Белая монетизация мобильного и социального трафика для рунета. Есть международные мобильные офферы, отзывчивая поддержка и частые выплаты. Сеть на платформе HasOffers.';
    private $params = array(
        ...
        't30' => array('url_param'=>'mobile_ip', 'caption'=>'mobile_ip'),
