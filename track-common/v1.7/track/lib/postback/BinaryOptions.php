...
class BinaryOptions {
    public $network_name = 'BinaryOptions';
    private $display_url = 'binaryoptions-affiliate.com';
    private $registration_url = 'http://www.cpatracker.ru/networks/binaryoptions';
    private $network_description = 'Партнерская программа для продвижения бинарных опционов 24Option';
