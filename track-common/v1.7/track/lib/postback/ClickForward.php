...
class ClickForward {
    ...
    public $network_name = 'ClickForward';
    private $display_url = 'www.clickforward.net';
    private $registration_url = 'http://www.cpatracker.ru/networks/clickforward';
    private $network_description = 'Международная партнерская сеть с большим количеством офферов по всем странам мира. Монетизация мобильного​ и десктоп​ трафика (операторский, Wi-Fi​, Web), incentive офферы, автоматический подбор рекламодателя под ваше гео. Система делает выплаты в WebMoney, Яндекс.Деньги, Paypal. Есть русскоязычный саппорт.';
    private $params = array(
        ...
        't25' => array('url_param'=>'mac_address', 'caption'=>'Маc адрес'),
